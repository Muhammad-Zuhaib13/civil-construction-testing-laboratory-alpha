...
>
  ...
  <p style="font-size: 16px; text-align: center">
    Thank you for reaching out! We have received your details and will get back
    to you shortly.
  </p>
  ...
  <div style="display: grid; gap: 12px">
    ...
    >
      <p style="font-size: 16px; margin: 0">
        📞 <strong>Mobile:</strong> 0312-9047134
      </p>
      <p style="font-size: 16px; margin: 0">
        💬 <strong>WhatsApp:</strong> 0347-9008870
      </p>
      <p style="font-size: 16px; margin: 0">
        📧 <strong>Email:</strong> g.abbasskd@gmail.com
      </p>
      <p style="font-size: 16px; margin: 0">
        🌐 <strong>Website:</strong>
        <a
          href="https://civil-construction-testing-laboratory-alpha-j1vk.vercel.app/"
