    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
          ...
          <p style="display:flex; gap:12px;font-size: 18px ; margin:0;"> <span><strong>Mobile: </strong></span>
          <span>0312-9047134</span></p>
           <p style="display:flex; gap:12px;font-size: 18px; margin:0 12px; ">  <span> <strong>Whatsapp:  </strong></span>
                  <span>0347-9008870</span></p>
          </div>
